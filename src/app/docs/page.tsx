...
// App name from Settings (DB) → env APP_NAME → fallback "WebotApp WhatsApp".
async function getAppName(): Promise<string> {
    ...
    return process.env.APP_NAME || 'WebotApp WhatsApp';
}
...
export default async function PublicDocsPage() {
    ...
    try {
        ...
        content =
            ...
            'The documentation file could not be loaded on this server.\n\n' +
            'In the meantime, you can explore:\n\n' +
            '- **[Swagger UI](/swagger)** — interactive API reference & endpoint testing\n' +
