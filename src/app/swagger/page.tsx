...
export default function ApiDocsPage() {
    ...
    // Fetch specification with error handling.
    useEffect(() => {
        ...
        fetch("/api/docs", { headers: { Accept: "application/json" } })
            .then(async (res) => {
                ...
                if (!ct.includes("application/json"))
                    throw new Error("Response is not JSON (possible redirect or server error)");
                return res.json();
            })
            .then((json) => {
                if (!active) return;
                ...
                <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
                    <div className="text-center mb-6">
                        <h1 className="text-3xl font-bold text-gray-800 mb-2">
                            WebotApp WhatsApp API Documentation
                        </h1>
        ...
        <div className="min-h-screen bg-white">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-4 shadow-lg">
                <div className="container mx-auto flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold">WebotApp WhatsApp API Documentation</h1>
